...
def train(model, train_loader, val_loader, optimizer, savepath, val_interval, patience, scheduler=None, device=None, epochs=10):
    """
    Args:
    ...
    for epoch in range(epochs):
        ...
        for batch_graph, batch_GT in train_loader:
        ...
        with torch.no_grad():
            for batch_graph, batch_GT in val_loader:
...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(train_dataset, batch_size=batch_size, num_workers = 4, shuffle=True,  collate_fn=hpe_supervised_collate_fn)
    val_loader   = DataLoader(val_dataset,   batch_size=batch_size, num_workers = 4, shuffle=False, collate_fn=hpe_supervised_collate_fn)
